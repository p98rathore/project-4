...
<%}%>
  ...
  <td ><input type="text" placeholder="Enter Physics Marks." name="physics"  style="width: 173px;resize: none;" value="<%=DataUtility.getStringData(bean.getPhysics())%>">
  </td>
  ...
  <td ><input type="text" placeholder="Enter Chemistry Marks." name="chemistry"  style="width: 173px;resize: none;" value="<%=DataUtility.getStringData(bean.getChemistry())%>">
  </td>
  ...
  <td ><input type="text" placeholder="Enter Maths Marks." name="maths"  style="width: 173px;resize: none;" value="<%=DataUtility.getStringData(bean.getMaths())%>">
  </td>
