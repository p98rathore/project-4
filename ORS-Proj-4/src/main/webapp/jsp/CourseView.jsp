...
<%@include file="Header.jsp"%>
   ...
   <%
List list = (List)request.getAttribute("Clist");
%>
...
<div align="center">
            ...
            <th align="left" style="padding: 7px"><font size="5px">Update Course</font></th>
            </tr>
            <%}else{%>
            <tr  id="aa" style="background-color: #eaeae1;">
            <th align="left" style="padding: 7px"><font size="5px">Add Course</font></th>
            </tr>
            <%}%>
			</h1>
...
<table align="center">
  ...
  <tr>
  <th align="left"><label>Course<span style="color: red">*</span></label></th>
  <td ><input type="text" placeholder="Enter Course." name="name" style="width: 173px;resize: none;" value="<%=DataUtility.getStringData(bean.getName())%>">
  </td>
  ...
  <td></td>
   ...
   <tr>
	...
	<td style="width: 173px;resize: none;">
	<%
  ...
  <td ><textarea placeholder="Enter Description." rows="3" style="width: 173px;resize: none;" name="description" >
  <%if(bean!=null && bean.getId()>0){ %>
 ...
 <%--  <tr>
	<th align="center">Duration<span style="color: red">*</span></th>
	<td>
	<%
  ...
  <th></th>
   <td colspan="2">
    ...
    {%> &emsp;
    <input type="submit" value="<%=CourseCtl.OP_UPDATE %>" name="operation">
    <input type="submit" value="<%=CourseCtl.OP_CANCEL %>" name="operation"> 
     <%}else{%>
     <input type="submit" value="<%=CourseCtl.OP_SAVE %>" name="operation">
     <input type="submit" value="<%=CourseCtl.OP_RESET %>" name="operation">
     <%}%>   
   </td>
   </tr>
