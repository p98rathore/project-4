...
public class SubjectModel {
	 ...
	 * @throws ApplicationException the application exception
	 */
	public static void delete(SubjectBean bean) throws ApplicationException {
	...
	public static List<SubjectBean> search(SubjectBean bean, int pageNo, int pageSize) throws ApplicationException {
